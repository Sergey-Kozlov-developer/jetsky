...
const CartItem: React.FC<CartItemProps> = ({
	...
	return (
		<>
			<div className="divide-y whitespace-nowrap">
				<div className="flex justify-center sm:flex-col sm:items-start md:flex-row md:items-center">
					<div className="p-4">
						<div className="flex w-max items-center gap-4 sm:flex-col md:flex-row">
							<div className="sm:pr-28 md:pr-0">
								<img
									src={img}
									className="h-full w-full items-start rounded-lg object-contain"
								/>
							</div>
							<div>
				...
				<div className="divide-solid divide-slate-500"></div>
			</div>
		</>
	);
};
